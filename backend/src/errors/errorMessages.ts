...
export const ERROR_MESSAGES: ErrorMessages = {
  ...
  PROJECT_MEMBER: {
    ...
    LAST_OWNER_CANNOT_BE_REMOVED: "Нельзя понизить или удалить последнего владельца проекта",
    FORBIDDEN: "Недостаточно прав для совершения этого действия",
    ALREADY_MEMBER: "Пользователь уже является членом проекта",
    NOT_MEMBER_OF_ORGANIZATION: "Пользователь не является членом организации, в которой находится проект",
  },
  TASK: {
